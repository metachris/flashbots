// https://github.com/onrik/ethrpc with Flashbots API calls (https://docs.flashbots.net/flashbots-auction/searchers/advanced/rpc-endpoint)
package ethrpc
...
func (rpc *EthRPC) CallWithFlashbotsSignature(method string, privKey *ecdsa.PrivateKey, params ...interface{}) (json.RawMessage, error) {
	request := ethRequest{
		ID:      1,
		JSONRPC: "2.0",
		Method:  method,
...
func (rpc *EthRPC) FlashbotsGetUserStats(privKey *ecdsa.PrivateKey, blockNumber uint64) (res FlashbotsUserStats, err error) {
...
func (rpc *EthRPC) FlashbotsCallBundle(privKey *ecdsa.PrivateKey, param FlashbotsCallBundleParam) (res FlashbotsCallBundleResponse, err error) {
